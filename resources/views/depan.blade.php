  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#partner">portfolio</a></li>
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">Education</a></li>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="{{Storage::url($jumbotron->thumnail)}}" alt="..." />
        <!-- Masthead Heading-->
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">{!! strip_tags($jumbotron->content) !!}</p> <!-- kebaca rtapi ada </p> nya
      </div>
    </header>
    <!-- Partner Section-->
      ...
      <div class="container">
        ...
        <div class="col-md-6 col-lg-4 mb-5">
          <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal {{$i}}">
            ...
            <img class="img-fluid" src="{{ Storage::url($item->thumnail) }}" alt="..." />
          </div>
        </div>
        <!-- last partner {{ $i }}-->
        @php
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 ms-auto text-center"><img src="{{Storage::url($about->thumnail)}}" class="w-75" /></div>
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container"><small>Copyright &copy; felby</small></div>
    </div>
    <!-- Partner Modals-->
    @php
      $i=1;
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  ...
                  <!-- Partner Modal - Image-->
                  <img class="img-fluid rounded mb-5" src="{{ Storage::url($item->thumnail)}}" alt="..." />
                  <!-- Partner Modal - Text-->
                  {!! $item->content !!}
                  <div class="m-5">
